package com.blz.techstack.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.techstack.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS-TechStack",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("LMS-TechStack", "http://blz.techstack", "gvpavangv14@gmail.com"),
                "Apache 2.0",
